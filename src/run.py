...
model = PPO(
    ...
    # model = PPO.load("./logs/checkpoints/ppo_checkpoint_100000_steps"
)
# tensorboard --logdir=./ppo_xarm_tensorboard/ 이걸로 봐
...
print(f"Robot Position: {obs['achieved_goal']}, Target Position: {obs['desired_goal']}")
obs = env.reset()
_states = None
